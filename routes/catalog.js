...
//GET request for creating book. NOTE: This must be come before routes display Genre (uses id).
...
//GET request for creating book. NOTE: This must be come before routes display bookinstance (uses id).
